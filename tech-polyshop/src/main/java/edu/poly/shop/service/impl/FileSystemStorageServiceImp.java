...
@Service
public class FileSystemStorageServiceImp implements StorageService{
...
public String getStoredFilename(MultipartFile file, String id) {
  ...
  public FileSystemStorageServiceImp(StorageProperties properties) {
...
public void store(MultipartFile file, String storedFilename) {
	  try {
		...
		if(!destinationFile.getParent().equals(this.rootLocation.toAbsolutePath())) {
			throw new StorageException("Can not store file outsile current directory");
